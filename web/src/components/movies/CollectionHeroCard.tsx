...
import { useMovieCollection, useAddAllMissing, useSetCollectionMonitor } from '@/api/movieCollections';
...
export function CollectionHeroCard({
  ...
  // Add-all dialog field state — mirrors `MovieCollectionBlock` verbatim.
