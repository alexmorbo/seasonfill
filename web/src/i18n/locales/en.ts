export const en = {
  ...
  health: {
    ...
    subtitle: 'Operator pulse — a count and drill-down per health signal.',
    generatedAt: 'Snapshot {{time}}',
    refresh: 'Refresh',
    refreshing: 'Refreshing…',
    loadFailed: 'Failed to load catalog health',
    expand: 'Show details',
    collapse: 'Hide details',
    drilldownEmpty: 'No rows',
    truncated: 'Showing first {{shown}} of {{total}}',
    allHealthy: {
      title: 'All healthy',
      description: 'No problem rows found across any signal.',
    },
    signals: {
      missingTvdbId: {
        label: 'Missing TVDB id',
        description: "Series with no tvdb_id — Sonarr can't match them.",
      },
      missingPoster: {
        label: 'Missing poster',
        description: 'Series with no poster in any language.',
      },
      staleEnrichment: {
        label: 'Stale enrichment',
        description: 'Metadata not synced with TMDB for a long time.',
      },
      stuckGrabs: {
        label: 'Stuck grabs',
        description: 'Grabs stuck in an intermediate state.',
      },
      deadLetters: {
        label: 'Dead-letter events',
        description: 'Webhook events parked after exhausting retries.',
      },
      rateLimitPressure: {
        label: 'Rate-limit pressure',
        description: 'Pressure on the Sonarr rate limit.',
        deferred: 'Deferred',
        metricLabel: 'Metric',
      },
    },
    item: {
      ...
      attempts_few: '{{count}} attempts',
      attempts_many: '{{count}} attempts',
  ...
  gaps: {
    title: 'Library gaps',
    subtitle: 'Missing monitored episodes, grouped by instance, series and season.',
    generatedAt: 'Snapshot {{time}}',
    refresh: 'Refresh',
    refreshing: 'Refreshing…',
    loadFailed: 'Failed to load library gaps',
    expand: 'Show episodes',
    ...
    counters: {
      ...
      wholeSeason_one: '{{count}} full season',
      wholeSeason_few: '{{count}} full seasons',
      wholeSeason_many: '{{count}} full seasons',
      wholeSeason_other: '{{count}} full seasons',
    },
    allHealthy: {
      title: 'No gaps',
      description: 'Every monitored, aired episode is on disk across all instances.',
    },
    instanceHealthy: {
      title: 'No gaps',
      description: 'Every monitored, aired episode is on disk for this instance.',
    },
    series: {
      fallback: '#{{id}}',
    ...
    season: {
      label: 'Season {{n}}',
      ratio: '{{missing}} of {{aired}} aired',
      fullyMissing: 'S{{n}} fully missing',
    },
  },
  calendar: {
    title: 'Release calendar',
    subtitle: 'Upcoming and recent episodes across your library and watchlist.',
    refresh: 'Refresh',
    refreshing: 'Refreshing…',
    view: { agenda: 'Agenda', month: 'Month' },
    thisWeek: 'This week',
    upcoming: 'Upcoming',
    empty: 'No episodes in this window.',
  ...
  lists: {
    title: 'Smart lists',
    subtitle: 'Curated shelves per instance: ended with gaps, returning soon, and on hiatus.',
    generatedAt: 'Snapshot {{time}}',
    refresh: 'Refresh',
    refreshing: 'Refreshing…',
    loadFailed: 'Failed to load smart lists',
    shelfEmpty: 'Empty',
    empty: {
      title: 'No instances',
      description: 'No instance has library data yet.',
    },
    shelf: {
      ended_incomplete: 'Ended with gaps',
      returning_soon: 'Returning soon',
      hiatus: 'On hiatus',
    },
    series: {
      fallback: '#{{id}}',
      missing_one: '{{count}} episode missing',
      missing_few: '{{count}} episodes missing',
      missing_many: '{{count}} episodes missing',
      missing_other: '{{count}} episodes missing',
      nextAir: 'airs {{time}}',
  ...
  collections: {
    title: 'Collections',
    subtitle: 'Curated thematic shelves of the library grouped by TMDB keywords.',
    generatedAt: 'Snapshot {{time}}',
    refresh: 'Refresh',
    refreshing: 'Refreshing…',
    ...
    franchise: 'franchise',
    bucketEmpty: 'Empty',
    instanceEmpty: 'No matching collections for this instance.',
    empty: {
      title: 'No instances',
      description: 'No instance has library data yet.',
    },
  ...
  stats: {
    ...
    subtitle: 'Catalog size, genre and network distribution, grabs and torrents per instance.',
    generatedAt: 'Snapshot {{time}}',
    refresh: 'Refresh',
    refreshing: 'Refreshing…',
    ...
    seriesCount_few: '{{count}} series',
    seriesCount_many: '{{count}} series',
    seriesCount_other: '{{count}} series',
    byGenre: 'By genre · size on disk',
    byNetwork: 'By network · size on disk',
    emptyGenre: 'No series with genres.',
    emptyNetwork: 'No series with networks.',
    totals: {
      series: 'series',
    ...
    grab: {
      ...
      imported_few: '{{count}} imported',
      imported_many: '{{count}} imported',
      imported_other: '{{count}} imported',
      grabbed_one: '{{count}} in progress',
      grabbed_few: '{{count}} in progress',
      grabbed_many: '{{count}} in progress',
      grabbed_other: '{{count}} in progress',
      failed_one: '{{count}} failed',
      failed_few: '{{count}} failed',
      failed_many: '{{count}} failed',
    ...
    torrents: {
      ...
      count_few: '{{count}} torrents',
      count_many: '{{count}} torrents',
      count_other: '{{count}} torrents',
      ratio: 'avg ratio {{ratio}}',
    },
    empty: {
      title: 'No data yet',
      description: 'No instance has cached series. Run a scan and come back.',
    },
  },
  instanceQueue: {
    title: 'Queue',
  ...
  discovery: {
    title: 'Discover',
    edit: {
      button: 'Customize rows',
      done: 'Done',
      title: 'Row customization',
      hint: 'Drag rows or use the arrows to reorder',
      drag: 'Drag',
      enabled: 'Show row',
      remove: 'Remove row',
      moveUp: 'Up',
      ...
      resetConfirm: 'Reset row configuration to defaults?',
      saved: 'Row configuration saved',
      saveFailed: 'Could not save: {{error}}',
      resetDone: 'Rows reset to defaults',
      resetFailed: 'Could not reset: {{error}}',
      add: {
        button: 'Add row',
        type: 'Row type',
        type_genre: 'Genre',
        ...
        type_watch_provider: 'Streaming',
        genre_placeholder: 'Pick a genre',
        network_placeholder: 'Pick a network',
    ...
    rowType: {
      ...
      network: 'Network',
      keyword: 'Keyword',
      watch_provider: 'Streaming',
      recently_added: 'Recently added',
      upcoming_releases: 'Coming soon',
    },
    rails: {
    ...
    add: {
      ...
      quality_profile_placeholder: 'Select profile',
      quality_profile_loading: 'Loading profiles…',
      ...
      seasons: {
        ...
        specials: 'Specials',
        season_n: 'Season {{n}}',
        episodes_count_one: '{{count}} episode',
      ...
      errors: {
        ...
        unknown: 'Failed to add. Try again later.',
      },
    },
    error: {
    ...
    filter: {
      prompt: 'Pick some filters to start',
      apply: 'Apply',
      clear: 'Clear',
      load_more: 'Load more',
      genres: 'Genres',
    ...
    sort: {
      ...
      vote_desc: 'Rating ↓',
      first_air_desc: 'Newest first',
      first_air_asc: 'Oldest first',
    },
  },
  grabs: {
    title: 'Grabs',
  ...
  settings: {
    ...
    profile: {
      ...
      avatar_mode_label: 'Avatar mode',
      avatar_mode: {
        auto: 'Auto (Gravatar when email is set, otherwise monogram)',
        monogram: 'Monogram',
        gravatar: 'Gravatar',
      },
      save: 'Save',
      ...
      load_failed_title: 'Could not load profile',
      language_save_failed: 'Could not save language: {{msg}}',
      oidc_profile_link: 'Open identity provider profile',
      oidc_managed_no_link: 'Your profile is managed by your identity provider.',
      change_password: {
        ...
        too_short: 'Password must be at least {{n}} characters',
        mismatch: 'Passwords do not match',
        min_hint: 'At least {{n}} characters',
        unavailable_for_mode: 'Password change is not available for this authentication mode',
        unavailable_hint: 'Manage your credentials in your identity provider.',
        generic_error: 'Could not change password',
      },
    },
    system: {
    ...
    agents: {
      ...
      subtitle: 'Outbound notifications via shoutrrr (Telegram, Discord, Slack, …) for system events.',
      add: 'Add agent',
      empty: 'No notification agents yet. Add one to receive system event notifications.',
      loadErr: 'Failed to load notification agents.',
      name: 'Name',
      url: 'shoutrrr URL',
      urlKeepPlaceholder: 'Leave empty to keep the current one',
      urlHint: 'e.g. telegram://token@telegram?chats=123',
      configuredHint: 'Configured ({{scheme}})',
      enabled: 'Enabled',
      enabledBadge: 'Enabled',
      disabledBadge: 'Disabled',
      eventCount: '{{count}} events',
      eventCount_one: '{{count}} event',
      eventCount_few: '{{count}} events',
      eventCount_many: '{{count}} events',
      eventCount_other: '{{count}} events',
      eventTypes: {
        title: 'Event types',
        grabFailed: 'Grab failed',
        importFailed: 'Import failed',
        grabOk: 'Grab succeeded',
        watchdogRegrab: 'Watchdog regrab',
        inboxDeadLetter: 'Webhook dead-letter',
      ...
      testErr: 'Test notification failed{{err}}',
      save: 'Save',
      savedOk: 'Notification agent saved',
      savedErr: 'Save failed: {{err}}',
      delete: 'Delete agent',
      deleteConfirm: 'Delete notification agent "{{name}}"? This cannot be undone.',
      deletedOk: 'Notification agent deleted',
      form: {
        createTitle: 'New notification agent',
        editTitle: 'Edit notification agent',
      },
      errors: {
        nameRequired: 'Name is required',
  ...
  seriesDetail: {
    ...
    cast: {
      ...
      episodeCount_few: '{{count}} episodes',
      episodeCount_many: '{{count}} episodes',
    ...
    castPage: {
      ...
      tabs: {
        cast: 'Cast',
        crew: 'Crew',
        castFiltered: 'Cast ({{matched}} / {{total}})',
        crewFiltered: 'Crew ({{matched}} / {{total}})',
      },
      counts: {
        cast_one: '{{count}} cast member',
        cast_few: '{{count}} cast members',
        cast_many: '{{count}} cast members',
        cast_other: '{{count}} cast members',
        crew_one: '{{count}} crew member',
        crew_few: '{{count}} crew members',
        crew_many: '{{count}} crew members',
        crew_other: '{{count}} crew members',
      },
      empty: {
        both: 'No cast or crew data available from TMDB.',
        cast: 'No cast data available.',
        crew: 'No crew data available.',
      ...
      loadFailedTitle: 'Failed to load cast',
      loadFailedBody: 'The cast & crew list could not be loaded. Try refreshing.',
    },
    seasons: {
      label: 'Seasons',
      season: 'Season {{n}}',
      ...
      episodesCount_few: '{{count}} episodes',
      episodesCount_many: '{{count}} episodes',
      episodesCount_other: '{{count}} episodes',
      onDisk: '{{on}}/{{total}} on disk',
      runtime: '{{mins}}m',
      missing: 'Missing',
      unmonitored: 'Unmonitored',
      monitored: 'Monitored',
      request: 'Request',
      requestInInstance: 'Request in {{name}}',
    ...
    recommendations: {
      ...
      addCta: 'Add to Sonarr',
    },
    torrents: {
      label: 'Torrents',
      syncedAgo: 'synced {{time}}',
      allDeletedNote: 'All {{count}} torrents removed from client.',
      state: {
      ...
      summary: {
        downloading_one: '{{count}} downloading',
        downloading_few: '{{count}} downloading',
        downloading_many: '{{count}} downloading',
        downloading_other: '{{count}} downloading',
        seeding_one: '{{count}} seeding',
        seeding_few: '{{count}} seeding',
        seeding_many: '{{count}} seeding',
        seeding_other: '{{count}} seeding',
        stalled_one: '{{count}} stalled',
        stalled_few: '{{count}} stalled',
        stalled_many: '{{count}} stalled',
        stalled_other: '{{count}} stalled',
        queued_one: '{{count}} queued',
        queued_few: '{{count}} queued',
        queued_many: '{{count}} queued',
        queued_other: '{{count}} queued',
        paused_one: '{{count}} paused',
        paused_few: '{{count}} paused',
        paused_many: '{{count}} paused',
        ...
        error_few: '{{count}} errors',
        error_many: '{{count}} errors',
        error_other: '{{count}} errors',
        unknown_one: '{{count}} unknown',
        unknown_few: '{{count}} unknown',
        unknown_many: '{{count}} unknown',
        unknown_other: '{{count}} unknown',
        deleted_one: '{{count}} deleted',
        deleted_few: '{{count}} deleted',
        deleted_many: '{{count}} deleted',
        deleted_other: '{{count}} deleted',
      },
      empty: {
        never: {
          title: 'No torrents for this series yet',
          body: 'Torrents appear here when Sonarr grabs releases via qBittorrent.',
        },
        'all-deleted': {
          title: 'All torrents removed',
          body: 'History is kept below so you can see what was there.',
        },
      },
      stale: {
        banner: 'qBittorrent unreachable — showing last known state ({{time}})',
      },
      eta: {
        now: 'now',
      },
  ...
  person: {
    pageTitle: 'Person',
    knownFor: 'Known for {{department}}',
    bornOn: 'Born {{date}}',
    bornIn: 'Born {{date}} in {{place}}',
    diedOn: 'Died {{date}}',
    age_one: '{{count}} y.o.',
    age_few: '{{count}} y.o.',
    age_many: '{{count}} y.o.',
    ...
    invalidTmdb: 'Invalid person link.',
    loadFailedTitle: 'Failed to load person',
    ...
    bio: {
      ...
      readLess: 'Read less',
      langFallback: 'EN',
      source: 'Source: TMDB · updated {{rel}}',
    },
    library: {
      heading: 'In your library · {{count}} series',
    },
    other: {
      heading: 'Other titles · top {{count}}',
    ...
    relTime: {
      ...
      minutesAgo_few: '{{count}} minutes ago',
