...
export const ru: Translations = {
  ...
  health: {
    ...
    subtitle: 'Оперативный пульс — счётчик и разбор проблем по каждому сигналу.',
    generatedAt: 'Снимок {{time}}',
    refresh: 'Обновить',
    refreshing: 'Обновление…',
    loadFailed: 'Не удалось загрузить состояние каталога',
    expand: 'Показать',
    collapse: 'Свернуть',
    drilldownEmpty: 'Нет записей',
    truncated: 'Показаны первые {{shown}} из {{total}}',
    allHealthy: {
      title: 'Всё в порядке',
      description: 'Проблемных записей не найдено ни по одному сигналу.',
    },
    signals: {
      missingTvdbId: {
        label: 'Без TVDB id',
        description: 'Сериалы без tvdb_id — Sonarr не может их сопоставить.',
      },
      missingPoster: {
        label: 'Без постера',
        description: 'Сериалы без постера на любом языке.',
      },
      staleEnrichment: {
        label: 'Устаревшие метаданные',
        description: 'Давно не синхронизировались с TMDB.',
      },
      stuckGrabs: {
        label: 'Зависшие захваты',
        description: 'Захваты, застрявшие в промежуточном статусе.',
      },
      deadLetters: {
        label: 'Необработанные события',
        description: 'События вебхуков, отложенные после исчерпания попыток.',
      },
      rateLimitPressure: {
        label: 'Нагрузка на лимиты',
        description: 'Давление на rate-limit Sonarr.',
        deferred: 'Отложено',
        metricLabel: 'Метрика',
      },
    },
    item: {
      seriesFallback: '#{{id}}',
      season: 'Сезон {{n}}',
      attempts_one: '{{count}} попытка',
      attempts_few: '{{count}} попытки',
      attempts_many: '{{count}} попыток',
      attempts_other: '{{count}} попытки',
      tier: {
        hot: 'горячий',
        normal: 'обычный',
        cold: 'холодный',
  ...
  gaps: {
    title: 'Пробелы библиотеки',
    subtitle: 'Недостающие monitored-эпизоды по инстансам, сериалам и сезонам.',
    generatedAt: 'Снимок {{time}}',
    refresh: 'Обновить',
    refreshing: 'Обновление…',
    loadFailed: 'Не удалось загрузить пробелы библиотеки',
    expand: 'Показать эпизоды',
    collapse: 'Свернуть эпизоды',
    counters: {
      missing_one: '{{count}} эпизод недостаёт',
      missing_few: '{{count}} эпизода недостаёт',
      missing_many: '{{count}} эпизодов недостаёт',
      missing_other: '{{count}} эпизодов недостаёт',
      wholeSeason_one: '{{count}} полный сезон',
      wholeSeason_few: '{{count}} полных сезона',
      wholeSeason_many: '{{count}} полных сезонов',
      wholeSeason_other: '{{count}} полных сезонов',
    },
    allHealthy: {
      title: 'Пробелов нет',
      description: 'Все monitored-эпизоды, вышедшие в эфир, на диске во всех инстансах.',
    },
    instanceHealthy: {
      title: 'Пробелов нет',
      description: 'Все monitored-эпизоды, вышедшие в эфир, на диске в этом инстансе.',
    },
    series: {
      fallback: '#{{id}}',
      missing_one: 'недостаёт {{count}}',
      missing_few: 'недостаёт {{count}}',
      missing_many: 'недостаёт {{count}}',
      missing_other: 'недостаёт {{count}}',
    },
    season: {
      label: 'Сезон {{n}}',
      ratio: '{{missing}} из {{aired}} в эфире',
      fullyMissing: 'Сезон {{n}} полностью отсутствует',
    },
  },
  calendar: {
    title: 'Календарь релизов',
    subtitle: 'Скоро выходящие и недавние эпизоды из библиотеки и списка слежения.',
    refresh: 'Обновить',
    refreshing: 'Обновление…',
    view: { agenda: 'Список', month: 'Месяц' },
    thisWeek: 'На этой неделе',
    upcoming: 'Далее',
    empty: 'Нет эпизодов в этом окне.',
    ...
    state: {
      ...
      missing: 'Отсутствует',
      upcoming: 'Скоро',
      followed_not_in_library: 'Слежу (нет в библиотеке)',
    },
    subscribe: {
      title: 'Подписка на календарь',
      cta: 'Подписаться на календарь',
      copy: 'Скопировать',
      copied: 'Скопировано',
      openInApp: 'Открыть в календаре',
      revoke: 'Отозвать все подписки',
      revoked: 'Все подписки отозваны',
      scope: 'Что включить',
      scopeAll: 'Всё',
      scopeLibrary: 'Только библиотека',
      scopeFollowed: 'Только отслеживаемое',
      instructions:
        'Скопируйте ссылку и добавьте её в Google Calendar (Настройки → Добавить календарь → По URL) или Apple Calendar (Файл → Новая подписка на календарь). Ссылка webcal:// открывается в приложении календаря одним кликом.',
      mintFailed: 'Не удалось создать ссылку-подписку',
      revokeFailed: 'Не удалось отозвать подписки',
    },
  },
  lists: {
    title: 'Умные списки',
    subtitle: 'Готовые подборки по инстансам: завершённые с пропусками, скоро новые серии, на паузе.',
    generatedAt: 'Снимок {{time}}',
    refresh: 'Обновить',
    refreshing: 'Обновление…',
    loadFailed: 'Не удалось загрузить умные списки',
    shelfEmpty: 'Пусто',
    empty: {
      title: 'Нет инстансов',
      description: 'Пока нет ни одного инстанса с данными библиотеки.',
    },
    shelf: {
      ended_incomplete: 'Завершённые с пропусками',
      returning_soon: 'Скоро новые серии',
      hiatus: 'На паузе',
    },
    series: {
      fallback: '#{{id}}',
      missing_one: 'не хватает {{count}} эпизода',
      missing_few: 'не хватает {{count}} эпизодов',
      missing_many: 'не хватает {{count}} эпизодов',
      missing_other: 'не хватает {{count}} эпизодов',
      nextAir: 'эфир {{time}}',
      lastAired: 'последний эфир {{time}}',
    },
  },
  collections: {
    title: 'Коллекции',
    subtitle: 'Готовые тематические подборки библиотеки по ключевым словам TMDB.',
    generatedAt: 'Снимок {{time}}',
    refresh: 'Обновить',
    refreshing: 'Обновление…',
    ...
    franchise: 'франшиза',
    bucketEmpty: 'Пусто',
    instanceEmpty: 'Нет подходящих коллекций для этого инстанса.',
    empty: {
      title: 'Нет инстансов',
      description: 'Пока нет ни одного инстанса с данными библиотеки.',
    },
    bucket: {
      ...
      scifi_alt: 'Sci-fi и альт-история',
      true_story: 'Основано на реальных событиях',
      period: 'Период-драма',
      comics: 'Кинокомиксы',
      dark_comedy: 'Тёмная комедия',
      anthology: 'Антологии',
      mcu: 'MCU',
    },
    series: {
  ...
  stats: {
    ...
    subtitle: 'Объём каталога, распределение по жанрам и сетям, захваты и раздачи по инстансам.',
    generatedAt: 'Снимок {{time}}',
    refresh: 'Обновить',
    refreshing: 'Обновление…',
    loadFailed: 'Не удалось загрузить статистику',
    unknownLabel: 'Без названия',
    seriesCount_one: '{{count}} сериал',
    seriesCount_few: '{{count}} сериала',
    seriesCount_many: '{{count}} сериалов',
    seriesCount_other: '{{count}} сериалов',
    byGenre: 'По жанрам · объём на диске',
    byNetwork: 'По сетям · объём на диске',
    emptyGenre: 'Нет сериалов с жанрами.',
    emptyNetwork: 'Нет сериалов с сетями.',
    totals: {
      series: 'сериалов',
      episodes: 'эпизодов на диске',
      size: 'объём на диске',
    },
    grab: {
      title: 'Захваты',
      imported_one: '{{count}} импортирован',
      imported_few: '{{count}} импортировано',
      imported_many: '{{count}} импортировано',
      imported_other: '{{count}} импортировано',
      grabbed_one: '{{count}} в процессе',
      grabbed_few: '{{count}} в процессе',
      grabbed_many: '{{count}} в процессе',
      grabbed_other: '{{count}} в процессе',
    ...
    torrents: {
      title: 'Раздачи (qBittorrent)',
      count_one: '{{count}} раздача',
      count_few: '{{count}} раздачи',
      count_many: '{{count}} раздач',
      count_other: '{{count}} раздач',
      ratio: 'ср. рейтинг {{ratio}}',
    },
    empty: {
      title: 'Пока нет данных',
      description: 'Ни один инстанс не содержит закешированных сериалов. Запустите скан и вернитесь.',
    },
  },
  instanceQueue: {
    title: 'Очередь',
  ...
  discovery: {
    title: 'Обзор',
    edit: {
      button: 'Настроить ряды',
      done: 'Готово',
      title: 'Настройка рядов',
      hint: 'Перетащите ряды или используйте стрелки, чтобы изменить порядок',
      drag: 'Перетащить',
      enabled: 'Показывать ряд',
      remove: 'Удалить ряд',
      moveUp: 'Вверх',
      moveDown: 'Вниз',
      save: 'Сохранить',
      ...
      resetConfirm: 'Сбросить настройку рядов к стандартной?',
      saved: 'Настройка рядов сохранена',
      saveFailed: 'Не удалось сохранить: {{error}}',
      resetDone: 'Ряды сброшены к стандартным',
      resetFailed: 'Не удалось сбросить: {{error}}',
      add: {
        button: 'Добавить ряд',
        type: 'Тип ряда',
        type_genre: 'Жанр',
        type_network: 'Сеть',
        type_keyword: 'Ключевое слово',
        type_watch_provider: 'Стриминг',
        genre_placeholder: 'Выберите жанр',
    ...
    rowType: {
      trending: 'Тренды',
      popular: 'Популярное',
      upcoming: 'Новые сериалы',
      genre: 'Жанр',
      network: 'Сеть',
      keyword: 'Ключевое слово',
      watch_provider: 'Стриминг',
      recently_added: 'Недавно добавленное',
      upcoming_releases: 'Скоро на экраны',
    },
    rails: {
  ...
  settings: {
    ...
    agents: {
      title: 'Агенты уведомлений',
      subtitle: 'Исходящие уведомления через shoutrrr (Telegram, Discord, Slack, …) о системных событиях.',
      add: 'Добавить агента',
      empty: 'Агентов уведомлений пока нет. Добавьте агента, чтобы получать уведомления о системных событиях.',
      loadErr: 'Не удалось загрузить агентов уведомлений.',
      name: 'Название',
      url: 'shoutrrr URL',
      urlKeepPlaceholder: 'Оставьте пустым, чтобы сохранить текущий',
      urlHint: 'например, telegram://token@telegram?chats=123',
      configuredHint: 'Настроен ({{scheme}})',
      enabled: 'Включён',
      ...
      eventCount_other: '{{count}} событий',
      eventTypes: {
        title: 'Типы событий',
        grabFailed: 'Ошибка захвата',
        importFailed: 'Ошибка импорта',
        grabOk: 'Релиз захвачен',
        watchdogRegrab: 'Повторный захват (watchdog)',
        inboxDeadLetter: 'Webhook в dead-letter',
      ...
      testOk: 'Тестовое уведомление отправлено',
      testErr: 'Не удалось отправить тестовое уведомление{{err}}',
      save: 'Сохранить',
      savedOk: 'Агент уведомлений сохранён',
      savedErr: 'Не удалось сохранить: {{err}}',
      delete: 'Удалить агента',
      deleteConfirm: 'Удалить агента уведомлений «{{name}}»? Это действие необратимо.',
      deletedOk: 'Агент уведомлений удалён',
      form: {
        createTitle: 'Новый агент уведомлений',
        editTitle: 'Редактировать агента уведомлений',
      },
      errors: {
        nameRequired: 'Укажите название',
        urlRequired: 'Укажите shoutrrr URL',
      },
    },
  },
  reasons: {
  ...
  seriesDetail: {
    ...
    seasons: {
      ...
      monitored: 'Отслеживается',
      request: 'Запросить',
      requestInInstance: 'Запросить в {{name}}',
      requestQueued: 'Запрос отправлен',
      requestFailed: 'Не удалось запросить: {{error}}',
