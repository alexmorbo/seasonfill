...
export type paths = {
    ...
    readonly "/instances/{name}/torrents/{hash}/pause": {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path?: never;
        ...
        readonly put?: never;
        /**
         * Pause one of our torrents
         * @description Pauses a torrent grabbed through seasonfill. Hash-first guard: a
         *     hash outside our grab_records returns 404. Idempotent — pausing an
         *     already-paused torrent is a 200 no-op.
         */
        readonly post: {
            readonly parameters: {
                readonly query?: never;
            ...
            readonly responses: {
                ...
                readonly 200: {
                    ...
                    content: {
                        readonly "application/json": components["schemas"]["dto.TorrentActionResponse"];
                    };
                };
                /** @description Bad Request */
                readonly 400: {
    ...
    readonly "/instances/{name}/torrents/{hash}/recheck": {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path?: never;
    ...
    readonly "/instances/{name}/torrents/{hash}/resume": {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path?: never;
    ...
    readonly "/requests": {
         ...
         *     admin sees every request; a plain user sees only their own.
         */
        readonly get: {
            readonly parameters: {
                readonly query?: never;
            ...
            readonly responses: {
                ...
                readonly 200: {
                    ...
                    content: {
                        readonly "application/json": components["schemas"]["rest.requestListResponse"];
                    };
                };
                /** @description Unauthorized */
                readonly 401: {
    ...
    readonly "/requests/{id}/approve": {
         ...
         *     status=approved, and emits request.approved. Idempotent.
         */
        readonly post: {
            readonly parameters: {
                readonly query?: never;
            ...
            readonly responses: {
                ...
                readonly 200: {
                    ...
                    content: {
                        readonly "application/json": components["schemas"]["rest.requestItem"];
                    };
                };
                /** @description Bad Request */
                readonly 400: {
...
export type components = {
    schemas: {
        ...
        readonly "dto.NotificationAgentCreateRequest": {
            /** @example true */
            readonly enabled?: boolean;
            readonly event_types?: readonly string[];
            /** @example telegram-main */
            readonly name: string;
            /** @example telegram://token@telegram?chats=123 */
            readonly url: string;
        };
        readonly "dto.NotificationAgentListResponse": {
            readonly agents?: readonly components["schemas"]["dto.NotificationAgentView"][];
        };
        readonly "dto.NotificationAgentUpdateRequest": {
            /** @example true */
            readonly enabled?: boolean;
            readonly event_types?: readonly string[];
            /** @example telegram-main */
        ...
        readonly "dto.NotificationAgentView": {
            /** @example true */
        ...
        readonly "dto.NotificationTestResponse": {
            /** @example true */
            readonly ok?: boolean;
        };
        ...
        readonly "dto.TorrentActionResponse": {
            /** @description pause | resume | recheck */
            readonly action?: string;
            /** @description normalised 40-hex */
            readonly hash?: string;
