...
// 42 - 5 admin - 2 auth - 3 grab - 2 watchdog = 30. scan_runs stays
// in the schema because ATLAS_SCHEMA_SKIP_SCAN_RUNS is NOT set; the
// FK from grab_records is gone because grab tables are skipped.
