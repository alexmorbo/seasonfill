...
func TestParseSeason(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "single episode canonical", title: "Show.S03E07.1080p.WEB-DL", want: ptrInt(3)},
		{name: "lowercase", title: "show.s03e07.1080p.web-dl", want: ptrInt(3)},
		{name: "mixed case", title: "Show.s03E07.1080p", want: ptrInt(3)},
		{name: "two episodes same season E-pair", title: "Show.S03E07E08.1080p", want: ptrInt(3)},
		{name: "two episodes same season repeating prefix", title: "Show.S03E07.S03E08.1080p", want: ptrInt(3)},
		{name: "three episodes same season", title: "Show.S05E01E02E03.PROPER", want: ptrInt(5)},
		...
		{name: "dot separator S03.E07", title: "Show.S03.E07.1080p", want: ptrInt(3)},
		{name: "1x07 alternate schema returns nil", title: "Show.1x07.1080p", wantNil: true},
		{name: "four-digit season", title: "Show.S1999E01.WEIRD", want: ptrInt(1999)},
		...
		{name: "Severance S02E03 WEBRip", title: "Severance.S02E03.WEBRip.x264-NTb [RUS Sub]", want: ptrInt(2)},
