...
type RuntimeConfigDTO struct {
	...
	Security            RuntimeSecurityDTO  `json:"security"`
...
// RuntimeSecurityDTO holds DB-stored security toggles. AllowPrivateTargets,
// when true, lets the probe endpoint reach RFC1918/loopback/link-local/ULA
// destinations — required for homelab setups where Sonarr is exposed via
// internal ClusterIP / service-mesh URLs. Default false matches the
// SSRF-safe behaviour shipped in 028a.
type RuntimeSecurityDTO struct {
