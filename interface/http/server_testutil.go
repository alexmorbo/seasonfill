...
func newServerForTest(t *testing.T, apiKey, cookieSecret string) *Server {
	t.Helper()
	...
	return NewServer(cfg, config.WebhookConfig{}, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, logger)
}
