...
//
//  1. All 21 migrations apply cleanly from an empty DB (no compound
//     failures, no partial-state crashes).
//  2. Every name in d1AcceptanceTablesPostgres (53 entries) is present
...
//  4. schema_migrations reports exactly 21 applied versions —
//     matches the 21 .up.sql files under
