...
test-lint-rule:
	go test -tags lint -run 'TestUseAnyRejectsInterfaceLiteral|TestBareIDIntRegression|TestModernizeRejectsLegacyPatterns|TestNoGormInApplication|TestMediaProxyNoBackwardsImports|TestAdminNoBackwardsImports|TestAdminPersistenceNoBackwardsImports|TestAdminRestNoBackwardsImports|TestGrabNoBackwardsImports|TestGrabPersistenceNoBackwardsImports|TestGrabRestNoBackwardsImports' ./tests/...
