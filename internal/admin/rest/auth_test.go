...
func setupAuth(t *testing.T, repo ports.UserRepository, lim *auth.IPLimiter) (*gin.Engine, *AuthHandler) {
	return setupAuthWithOpts(t, repo, lim)
}

func setupAuthWithOpts(t *testing.T, repo ports.UserRepository, lim *auth.IPLimiter, opts ...AuthOption) (*gin.Engine, *AuthHandler) {
	t.Helper()
...
func seedRepo(t *testing.T) *fakeAdminRepo {
	...
	require.NoError(t, err)
	return &fakeAdminRepo{user: &admin.User{
		ID: 1, Username: "admin", PasswordHash: hash, AutoGenerated: false,
	}}
}
