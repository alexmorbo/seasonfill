...
func (f *fakeSonarrClient) ListQualityProfiles(_ context.Context) ([]ports.QualityProfile, error) {
	return nil, nil
}
...
func (f *fakeSonarrClient) AddSeries(_ context.Context, _ ports.AddSeriesPayload) (ports.AddSeriesResult, error) {
