...
// @Description canonical series.id (lex-first instance that carries the
// @Description series in series_cache). 404 when no library carries the
// @Description series — TMDB-only series have no episode surface.
// @Tags        series
// @Produce     json
