...
func (f *abortFakeSonarr) ListQualityProfiles(_ context.Context) ([]ports.QualityProfile, error) {
	return nil, nil
}
func (f *abortFakeSonarr) ListRootFolders(_ context.Context) ([]ports.RootFolder, error) {
	return nil, nil
}
func (f *abortFakeSonarr) LookupSeries(_ context.Context, _ string) ([]ports.SonarrLookupResult, error) {
	return nil, nil
}
...
func (r *abortFakeScanRepo) IncrementSeriesScanned(_ context.Context, _ uuid.UUID, _ int) error {
	return nil
}
...
func (abortFakeDecisionRepo) UpdateIntent(_ context.Context, _ uuid.UUID, _ *decision.Intent) error {
	return nil
}
...
func (f *authFailFakeSonarrWrapped) ListQualityProfiles(_ context.Context) ([]ports.QualityProfile, error) {
	return nil, nil
}
func (f *authFailFakeSonarrWrapped) ListRootFolders(_ context.Context) ([]ports.RootFolder, error) {
	return nil, nil
}
func (f *authFailFakeSonarrWrapped) LookupSeries(_ context.Context, _ string) ([]ports.SonarrLookupResult, error) {
	return nil, nil
}
