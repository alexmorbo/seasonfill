...
func TestRefreshOneLanguage_FanoutFetchesAllSeasons(t *testing.T) {
	...
	err := w.refreshOneLanguage(context.Background(), fanoutCanon(), "en-US", false, &pe, &pw, &oe, new(bool), new(bool), quietLogger())
	require.NoError(t, err)
...
func TestRefreshOneLanguage_FanoutFirstErrorPropagates(t *testing.T) {
	...
	pe, pw, oe := false, false, false
	err := w.refreshOneLanguage(context.Background(), fanoutCanon(), "ru-RU", false, &pe, &pw, &oe, new(bool), new(bool), quietLogger())
	require.Error(t, err)
...
func TestRefreshOneLanguage_FanoutPreservesSeasonGate(t *testing.T) {
	...
	pe, pw, oe := false, false, false
	err := w.refreshOneLanguage(context.Background(), canon, "en-US", false, &pe, &pw, &oe, new(bool), new(bool), quietLogger())
	require.NoError(t, err)
	got := fake.fetchedSeasons()
