...
- **Chart version:** `0.4.2` (matches `Chart.yaml`)
- **App version:** `0.4.2`
...
Full reference: `helm show values oci://ghcr.io/alexmorbo/seasonfill-helm --version 0.4.2`.
...
`0.4.2` drops the `config.*` and `instances[]` values trees entirely.
